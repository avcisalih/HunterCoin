  ...
  return (
    <div className="container-xl mt-5">
      <h4 className="d-flex align-items-center gap-3">
        <FaBitcoin />
        <span>Hoş Geldiniz, Kripto Listesi</span>
      </h4>
      <p>
        Kripto listesi, dünya genelindeki kripto para birimlerini ve dijital
      ...
      <div className="d-flex justify-content-center align-items-center mb-5 mt-5">
        <button onClick={() => setPage((prev) => prev + 1)} className="ui-btn">
